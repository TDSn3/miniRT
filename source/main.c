...
/*   Updated: 2023/02/19 16:27:21 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	pixel_put ***********************************************************************
	...
	matrix1.tab[1][0] = 2; matrix1.tab[1][1] = 4; matrix1.tab[1][2] = 4; matrix1.tab[1][3] = 2;
	matrix1.tab[2][0] = 8; matrix1.tab[2][1] = 6; matrix1.tab[2][2] = 4; matrix1.tab[2][3] = 1;
	matrix1.tab[3][0] = 0; matrix1.tab[3][1] = 0; matrix1.tab[3][2] = 0; matrix1.tab[3][3] = 1;

	multiply_matrix_tuple(&tutu, &matrix1, &tu);
